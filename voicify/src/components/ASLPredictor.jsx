...
//           <div className="flex flex-col items-center justify-center h-full">
//             <p className="text-2xl text-white px-4">
//               Click the button to turn on the camera and start detecting hand poses.
//             </p>
//           </div>
//         )}
//       </div>
...
// const ASLPredictor = forwardRef(({ onCameraStatusChange }, ref) => {
//   const [isCameraOn, setIsCameraOn] = useState(false);
//   const [currentWord, setCurrentWord] = useState("");

//   // Poll backend for current word
//   useEffect(() => {
//     const interval = setInterval(async () => {
//       try {
//         const res = await fetch("http://localhost:8000/latest");
...
//   // Notify parent of camera toggle
//   useEffect(() => {
//     if (onCameraStatusChange) {
//       onCameraStatusChange(isCameraOn);
//     }
...
//         Current Word: <span className="font-bold text-green-400">{currentWord}</span>
//       </div>
//     </div>
//   );
// });
...
<button
  onClick={async () => {
    await fetch("http://localhost:8000/save", { method: "POST" });
  }}
...
>
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className="w-full h-[600px] bg-gray-600 overflow-hidden relative">
        {isCameraOn ? (
          <img
            src="http://localhost:8000/video"
            alt="OpenCV Feed"
